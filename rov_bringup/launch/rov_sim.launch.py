...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        arguments=['/model/rov_max/joint/shell_to_vert_thrust_left/cmd_thrust@std_msgs/msg/Float64@gz.msgs.Double',
                    ...
                    '/model/rov_max/imu@sensor_msgs/msg/Imu@gz.msgs.IMU',
                    '/model/rov_max/sonar@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan',
                    '/model/rov_max/sonar/points@sensor_msgs/msg/PointCloud2@gz.msgs.PointCloudPacked',
                    '/model/rov_max/pose@geometry_msgs/msg/PoseArray@gz.msgs.Pose_V',],

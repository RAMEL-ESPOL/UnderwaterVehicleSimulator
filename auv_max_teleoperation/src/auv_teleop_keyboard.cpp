...
class MaxTeleop : public rclcpp::Node {
public:
    MaxTeleop() : Node("auv_teleop") {
        cmd_vel_pub_ = this->create_publisher<geometry_msgs::msg::Twist>("/model/auv_max/cmd_vel", 10);
    ...
    void printMsg()
    {
        ...
        mvprintw(0, 15, "Control del AUV Max");
        mvprintw(1, 0, "--------------------------------------------------");
        ...
        mvprintw(31, 0, "Pulse una tecla para mover el AUV Max...   ");
    }
...
int main(int argc, char** argv) {
    ...
    auto node = std::make_shared<MaxTeleop>();
    node->run();
    rclcpp::shutdown();
    return 0;
}
